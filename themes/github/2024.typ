...
#let svg(file, fill: color_font_mid, width: 2.5mm) = {
  show: predefined_svg("/themes/github/icons/" + file + ".svg", fill: fill, width: width)
}
...
show:box(
  inset: (top: 0.4em),
    minor-titled-sections(
      ...
      minor-titled-section(title: "Skills", topic-bubble-container(personal_data.skills.sorted())),
